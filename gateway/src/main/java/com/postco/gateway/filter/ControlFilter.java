...
@Component
public class ControlFilter extends AbstractGatewayFilterFactory<ControlFilter.Config> {
    private static final Logger logger = LogManager.getLogger(ControlFilter.class);
