...
public interface ErrorMaterialQueryService {
    /**
    ...
    /**
     * 특정 공정의 에러 상태 작업 대상재를 불러오고 관련 정보를 매핑하는 메서드
     *
     * @param currProc 현재 공정
     * @return Mono<List < TargetViewDTO>> 특정 공정의 에러 상태 작업 대상재와 관련 정보가 매핑된 TargetViewDTO 리스트
     */
    Mono<List<TargetViewDTO>> getErrorMaterialsByCurrProc(String currProc);
