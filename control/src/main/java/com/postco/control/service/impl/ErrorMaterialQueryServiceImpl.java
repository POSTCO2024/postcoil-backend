...
import com.postco.control.service.ErrorMaterialQueryService;
...
public class ErrorMaterialQueryServiceImpl implements ErrorMaterialQueryService {
    ...
    @Override
    public Mono<List<TargetViewDTO>> getErrorMaterialsByCurrProc(String currProc) {
        return getTargetViewDTOs(this::getErrorMaterials)
